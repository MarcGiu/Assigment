...
#include <memory>
#include "../../SensorApp/src/View/searchwidget.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_SearchWidget_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_SearchWidget_t qt_meta_stringdata_SearchWidget = {
    {
QT_MOC_LITERAL(0, 12), // "SearchWidget"
QT_MOC_LITERAL(13, 16), // "addButtonClicked"
QT_MOC_LITERAL(30, 0) // ""

    },
    "SearchWidget\0addButtonClicked\0"
};
...
void SearchWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SearchWidget::addButtonClicked)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject SearchWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_SearchWidget.offsetsAndSize,
    qt_meta_data_SearchWidget,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_SearchWidget_t
, QtPrivate::TypeAndForceComplete<SearchWidget, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
...
// SIGNAL 0
void SearchWidget::addButtonClicked()
{
